...
export const gotoEntCodeGovURL = (url) => {
    window.location.href = getURL('entCodeGov', url);
}
...
//打开新页面
export const gotoNewGovURL = (url) => {
    window.open(getURL('gov', url));
}
export const gotoNewEntURL = (url) => {
    window.open(getURL('ent', url));
}