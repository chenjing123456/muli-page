...
// 原型
    UploadImg.prototype = {
        ...
        insertLinkImg: function insertLinkImg(link) {
            ...
            editor.cmd.do('insertHTML', '<img src="' + link + '" style="width:100%;height: 100%;"/>');
            ...
            if (uploadImgServer && typeof uploadImgServer === 'string') {
                ...
                xhr.onreadystatechange = function () {
                    ...
                    if (xhr.readyState === 4) {
                        ...
                        // console.log(result,xhr.status,hooks);
                        ...
                        if (!hooks.customInsert  && result.errno == '0') {
                            ...
                            // 数据错误
                            _this3._alert('上传图片失败', '上传图片返回结果错误，返回结果 '+ result.errno );
                        } else {
                            if (hooks.customInsert && typeof hooks.customInsert === 'function') {
                                ...
                                // });
                                _this3.insertLinkImg(data.ossUrl);
                            }
...
// 原型
    UploadVideo.prototype = {
        ...
        insertLinkVideo:function(link){
            ...
            editor.cmd.do('insertHTML', '<video src="' + link + '" style="width:100%;height: 100%;" controls autobuffer autoplay muted/>');
        ...
        uploadVideo: function uploadVideo(files) {
            ...
            var editor = this.editor;
            var config = editor.config;
            var uploadVideoServer = editor.config.uploadVideoServer?editor.config.uploadVideoServer:"/video/uploadVideo";//上传地址
                    ...
                    if (xhr.readyState === 4) {
                        ...
                        if (!hooks.customInsert && result.errno == '0') {
                            ...
                            if (hooks.customInsert && typeof hooks.customInsert === 'function') {
                                ...
                                //
                                // });
                                _this3.insertLinkVideo(data.ossUrl);
                            }
